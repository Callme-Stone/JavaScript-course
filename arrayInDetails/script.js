...
employeesName.forEach((name) => {
    console.log(`Hi ${name} you have received an award for your great work`)
})


const creatures = [
    {animals: "Shark", habitat:"Ocean"},
    {animals: "Frog", habitat:"Lake"},
    {animals: "Hippopotamus", habitat:"Lake"},
    {animals: "Monkey", habitat:"Jungle"},
    {animals: "Lion", habitat:"Savanna"},
]
